...
// And what the menu's second sea does to it: the surf is the one layer already
// a function of the water, so it is the one the rollers belong in. It rides the
// same ramp the water does, so the sea comes up in the mix as it comes up in
// the frame rather than switching under it.
const SEA_ROLL = 0.85 // added to the calm sea's 1.0, at a full roller train
